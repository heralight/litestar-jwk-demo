Frontend sample inspired from https://github.com/zitadel/example-quote-generator-app.git

## Quick start

This project was tested against a zitadel oidc instance.

### Configuration

set your variable inside .env file

and configure accordingly your OIDC provider.
...
README from https://github.com/zitadel/example-quote-generator-app.git :
...
1. Create a service user as instructed [here](https://github.com/zitadel/examples-api-access-and-token-introspection/tree/main/service-user-client-credentials#2-create-a-service-user-with-client-credentials-in-zitadel-). You can skip creating the role and authorization.
